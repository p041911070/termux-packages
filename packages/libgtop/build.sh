...
TERMUX_PKG_SRCURL=https://download.gnome.org/sources/libgtop/${TERMUX_PKG_VERSION%.*}/libgtop-${TERMUX_PKG_VERSION}.tar.xz
TERMUX_PKG_SHA256=775676df958e2ea2452f7568f28b2ea581063d312773dd5c0b7624c1b9b2da8c
